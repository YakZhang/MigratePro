...
class DeviceState(object):
    ...
    def init_xml(self):
        ...
        xml_data = self.device.adb.shell('cat /sdcard/window_dump.xml')
        self.xml = xml_data
    ...
    def get_possible_input(self):
        ...
        for view_id in enabled_view_ids:
            if self.__safe_dict_get(self.views[view_id], 'editable'):
                ...
                # special for a2_category
                # possible_events.append(SetTextEvent(view=self.views[view_id], text='Sample Todo'))
                # special for a1_category
                possible_events.append(SetTextEvent(view=self.views[view_id], text='https: // www.ics.uci.edu'))
