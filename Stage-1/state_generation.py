...
import time
from postprocess_exploration import postprocess_explore_result,postprocess_explore_result_src
...
def explore_state(script_path,apk_path,save_path):
    # for craftdroid droidbot BFS
    test_name_list = [script_path]
    apk_name_list = [apk_path]
    ...
    for idx in range(len(test_name_list)):
        ...
        for round in range(max_round_num):
            ...
            apk_path = apk_name
            output_dir = save_path+ test_name+policy_file_name+'output_'+str(round)
