...
class InputManager(object):
    ...
    def __init__(self, device, app, policy_name, random_input,
                 ...
                 replay_output=None, script_target_path=None,
                 output_dir=None,
                 target_path=None,
                 watch_path=None
                 ):
        ...
        # get the script_target_views from the script_target_path
        if script_target_path is not None:
            self.script_target_view = self.get_script_target(script_target_path)
        ...
        self.policy.output_dir = self.output_dir
        self.profiling_method = profiling_method


    def get_script_target(self,script_target_path):
        f = open(script_target_path,'r')
        script_dict = json.load(f)
        return script_dict
    ...
    def get_input_policy(self, device, app, master):
        ...
        if isinstance(input_policy, UtgBasedInputPolicy):
            ...
            input_policy.target = self.target
            input_policy.watch = self.watch
            input_policy.master = master
            input_policy.script_target_view = self.script_target_view
        return input_policy
