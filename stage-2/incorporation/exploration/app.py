...
class App(object):
    ...
    def get_start_intent(self):
        ...
        # special for a32_b31-- wish (start activity =com.contextlogic.wish.activity.login.signin.SignInActivity)
        if 'a32' in self.app_path:
            package_name = 'com.contextlogic.wish/com.contextlogic.wish.activity.login.signin.SignInActivity'
